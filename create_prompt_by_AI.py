...
from generate_items import generate_recommendation_id
from add_data_in_collection import add_recommendation, add_tag
...
def generate_recommendations_by_AI(passcode, entries_generated_by_AI):
    ...
    while index < entries_generated_by_AI:
        ...
        condition, user_info = generate_user_profile(passcode)
