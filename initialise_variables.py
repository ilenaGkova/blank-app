...
question_time_available = f"How many minutes are you willing to spend in reducing stress daily ({min_time_limit} - {max_limit})?"
...
question_gender = "Gender"
genders = "Male", "Female", "Other", "Would Rather Not Say"
options = {
    "Not happened": 0,
    "Happened rarely": 1,
...
question_about_duration = "Duration"
