...
# Main Page Side Side Function
def get_past_recommendations(passcode, days_behind):
    ...
    user_past_recommendations = Recommendation_Per_Person.find(
        {'Passcode': passcode, 'Created_At': {'$gte': start_of_range, '$lte': end_of_today}})
